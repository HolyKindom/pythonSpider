...
def getVideoList():
    ...
    login.startLogin()
    my_url = r'http://www.maiziedu.com/course/501/'
    #for my_url in url_list:

    # my_url = raw_input('input url:')
    ...
    # pro_dir = r'%s\\%s\\%s' %(basedir,CourseFrom,pro_title)
    print pro_dir
    # print pro_dir
    if not os.path.exists(pro_dir):
        os.makedirs(pro_dir,0755)
